        ...
        <form action="{{ url('usuario/editar/'.$user->id)}}" method="post">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-5">
                    ...
                    required onkeyup="validarDireccion()" value="{{ $user->horarioComercial }}" Placeholder="Horario " autocomplete="off" onkeypress="return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode >= 48 && event.charCode <= 57)  || (event.charCode == 32) || (event.charCode == 46) || (event.charCode == 241)|| (event.charCode == 209)|| (event.charCode == 58) || (event.charCode == 45))">
                    </div>Comercial
                    <span></span>
                </div>
            </div>
