...
<div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <button class="btn btn-success" style=" font-size: 14px; border-radius: 4px; padding: 5px; box-shadow: 2px 2px 2px rgb(95, 93, 93);" data-toggle="modal" data-target="#add" href="" role="button">Añadir dispositivo </button>
