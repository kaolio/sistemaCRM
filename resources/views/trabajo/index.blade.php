...
<div class="container">
  <div class="col-3">
    ...
    <div class="input-group md-2">
      ...
      <input class="form-control required" id="orden" name="orden" autocomplete="off">
  ...
  <div class="d-flex">
    <div class="p-2">
      ...
      <button type="button" class="btn btn-primary text-white" id="modal3" disabled  data-toggle="modal" data-target="#exampleModal3">Cambiar Estado</button>
