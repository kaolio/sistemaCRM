      ...
      <div class="card-body">
          <div class="input-group">
            <span class="input-group-text" style=" background:rgb(29, 145, 195); color: aliceblue">Prioridad</span>
              ...
              <input type="text" name="tiempoEstimado" class="form-control" value="{{$trabajo->TiempoEstimado}}"
