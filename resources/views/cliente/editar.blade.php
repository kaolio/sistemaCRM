                    ...
                    <div class="row">
                      ...
                      <div class="col-5">
                        ...
                        <input type="text" id="poblacion" name="poblacion" class="form-control" 
                           value="{{$cliente->poblacion}}" onkeyup="" autocomplete="off" onkeypress="return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode >= 48 && event.charCode <= 57)  || (event.charCode == 32) || (event.charCode == 46) || (event.charCode == 241) || (event.charCode == 209))">
                        </div>
                      </div>
                      <div class="col-4">
                        <div class="input-group">
