...
<div class="card">
    <div class="card-header" style="background: #ffc107">
        ...
        <div align="center"  >
            <h3><b>TRABAJO PENDIENTE</b></h3>
        </div>
       
    </div>
    <div class="card-body" style="background: #ffc10785">
                    ...
                    @endcan
                        ...
                        <div class="card" style="display: inline-block;background: #ebc04185;">
                            <div class="card-header" align="center" style="background: #ffc10785">
                                <b style="color: black;font-style: inherit;">{{$pendiente->estado}}</b>
                            </div>
                            <div class="card-body" >
                                <font  face="Comic Sans MS,Arial,Verdana">
                                <h4 class="card-title" style="color: rgb(0, 0, 0);">#{{$pendiente->id}}</h4>
                                <p class="card-text" style="color: rgb(0, 0, 0)">{{$pendiente->nombreCliente}}</p>
                                </font>
                            </div>
                            <div class="card-footer text-center text-capitalize" style="color: rgb(0, 0, 0)">{{$pendiente->created_at}}</div>
                        </div> 
                        &nbsp;
                    </a>
                @endforeach
