...
<div class="card">
    <div class="card-header" style="background: #dc3545">
        <a href="/home" style="color: rgba(240, 210, 210, 0.534)">
        ...
        <div align="center"  >
            <h3 class="text-white"><b>ATENCION URGENTE</b></h3>
        </div>
       
    </div>
    <div class="card-body" style="background: #dc354693">
        ...
        <div class="card-body">
                ...
                @can('editar orden de trabajo')
                    ...
                    @endcan
                        ...
                        &nbsp;
                        <div class="card" style="display: inline-block;background: #dc354693;">
                            <div class="card-body" >
                                <font  face="Comic Sans MS,Arial,Verdana">
                                <h4 class="card-title" style="color: rgb(255, 255, 255);">#{{$urgente->id}}</h4>
                                <p class="card-text" style="color: rgb(255, 255, 255)">{{$urgente->nombreCliente}}</p>
                                </font>
                            </div>
                            <div class="card-footer text-center text-capitalize" style="color: rgb(255, 255, 255)">{{$urgente->created_at}}</div>
                        </div> 
                        &nbsp;
                    </a>
                @endforeach
