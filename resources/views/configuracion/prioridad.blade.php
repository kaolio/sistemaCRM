        ...
        <table class="table table-light" id="tablaUnidad">
            <thead class="table table-striped table-bordered text-white" style="background:rgb(2, 117, 216); color: aliceblue">
                <tr>
                  ...
                  <th class="text-center" style="width: 30%">Tiempo Estimado</th>
                ...
                var count = 0;
                    ...
                    for (  i = 0 ; i < filas; i++){ //cuenta la cantidad de busquedas por id
                        ...
                        if (dataResult.data[i].id != null) {
                            ...
                            dataResult.data[i].prioridad + "</td><td class='text-center' style= 'background: rgb(209, 244, 255)'>" +
                            dataResult.data[i].tiempo_estimado  + 
                                ...
                                '<div class="row justify-content-center">'+
                                    '<div class="input-group-prepend col-10">'+
                                        '<div class="input-group">'+
                                            ...
                                            '<input type="text" id="editPrioridad'+dataResult.data[i].id+'" name="editPrioridad" class="form-control" autocomplete="off" value="'+[dataResult.data[i].prioridad]+'">'+
                                        '</div>'+
                                    '</div>'+
                                '</div>'+
                            '</br>'+
